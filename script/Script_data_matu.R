...
DataMatu <- readRDS("C:/Users/vmartin/Desktop/Stage/GIT/Rouget_MATO/data_confidential/Maturité/ca.rds") #ensemble des données sans 2021
DataMatu2 <- readRDS("C:/Users/vmartin/Desktop/Stage/GIT/Rouget_MATO/data_confidential/Maturité/ca2.rds") #ensemble des données avec 2021
...
DataMatu_MUR2 <- DataMatu_MUR %>% 
  mutate(mat=ifelse(sex %in%  "I","Immature",
                   ifelse (matStage %in% c("0","1", "2A", "A"), "Immature", "Mature")))
